...
import { ArrowRight, EnvelopeSimple, Phone, SealCheck, Sparkle } from "@phosphor-icons/react/dist/ssr";
import { BenefitsGrid } from "@/components/benefits-grid";
import { CountUpStats } from "@/components/count-up-stats";
import { FloatingWhatsapp } from "@/components/floating-whatsapp";
import { ProjectGallery } from "@/components/project-gallery";
import { SiteHeader } from "@/components/site-header";
import { navItems, projects, revestimientoBenefits, services, stats, whatsappHref } from "@/lib/site-data";
...
export default function Home() {
  const jsonLd = {
    ...
    image: "https://ipool.cl/images/ipool-hero.webp",
    telephone: "+56 9 4435 7744",
    email: "contacto.ipool@gmail.com",
    areaServed: "Chile",
    url: "https://ipool.cl",
    description: "Limpieza, mantención y revestimiento en fibra de vidrio para piscinas.",
    sameAs: [],
  ...
  return (
    <>
      ...
      <main id="inicio" className="overflow-hidden bg-[#eef5ff]">
          ...
          <div className="relative mx-auto grid min-h-[calc(42rem-10rem)] max-w-7xl items-center sm:min-h-[calc(44rem-10rem)] md:min-h-[calc(48rem-10rem)] lg:min-h-[calc(100dvh-10rem)]">
            <div className="reveal-up max-w-[56rem]">
              <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-slate-200 bg-white/78 px-3 py-2 text-xs font-extrabold text-[#2f5eac] backdrop-blur-md sm:mb-6 sm:px-4 sm:text-sm">
                <Sparkle className="text-[#ffb600]" size={16} weight="fill" aria-hidden />
                <span className="truncate">Revestimiento, limpieza y mantencion</span>
              </div>
              <h1 className="max-w-[12ch] font-[var(--font-display)] text-[clamp(3rem,15vw,5rem)] font-black leading-[0.94] tracking-tight text-[#12242c] sm:max-w-[13ch] sm:text-6xl md:max-w-[14ch] md:text-7xl lg:max-w-[15ch] lg:text-8xl">
                Haz que tu piscina <span className="marker-highlight">brille todo el año.</span>
              </h1>
              <p className="mt-5 max-w-[36rem] text-base font-extrabold leading-7 text-[#102a36] sm:mt-6 sm:text-lg sm:leading-8 md:text-xl">
                Nosotros nos encargamos del revestimiento y la mantención para que disfrutes una piscina impecable,
                cristalina y lista para usar.
              </p>
        ...
        <section id="quienes-somos" className="px-4 py-8 sm:py-10 md:px-6 md:py-12">
                ...
                <div className="flex flex-col">
                  <div className="max-w-3xl">
                    ...
                    <h2 className="mt-5 font-[var(--font-display)] text-3xl font-black tracking-tight text-[#12242c] sm:text-4xl md:text-5xl">
                      Más que limpiar piscinas: cuidamos tu tranquilidad.
                    </h2>
                    <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                      Somos <strong>iPool</strong>, una empresa familiar con más de 7 años de experiencia en el rubro
                      piscinero. Partimos pintando piscinas de hormigón y luego pasamos a generar revestimientos en fibra
                      de vidrio con resultados de alta calidad.
                    </p>
                    <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                      Afinamos cada trabajo para entregar limpieza, mantención y revestimiento con resultados duraderos,
                      claros y listos para disfrutar durante todo el año.
                    </p>
                  </div>
        ...
        <section id="beneficios" className="px-4 py-8 sm:py-10 md:px-6 md:py-12">
          <div className="mx-auto max-w-7xl">
            <div className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-[0_30px_90px_-70px_rgba(75,133,226,0.65)] sm:p-6 lg:p-8">
              <div className="grid gap-5 md:grid-cols-[0.82fr_1.18fr] md:items-end">
                <div>
                  ...
                  <h2 className="mt-5 font-[var(--font-display)] text-3xl font-black tracking-tight text-[#12242c] sm:text-4xl md:text-5xl">
                    Fibra de vidrio para una piscina más firme, brillante y fácil de mantener.
                  </h2>
                </div>
                <p className="max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 md:justify-self-end">
                  iPool trabaja con revestimiento en fibra de vidrio reforzada, una solución impermeable y flexible que
                  renueva piscinas deterioradas y ayuda a evitar filtraciones.
                </p>
              </div>
              <div className="mt-10">
            ...
            <div className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-[0_30px_90px_-70px_rgba(75,133,226,0.65)] sm:p-6 lg:p-8">
              <div className="grid gap-6 md:grid-cols-[0.85fr_1.15fr] md:items-end">
                <div>
                  ...
                  <h2 className="mt-5 font-[var(--font-display)] text-3xl font-black tracking-tight text-[#12242c] sm:text-4xl md:text-5xl">
                    Dos formas de dejar tu piscina lista para disfrutar.
                  </h2>
                </div>
                <p className="max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 md:justify-self-end">
                  Combinamos recuperación estructural, agua clara y mantención preventiva para que la piscina se vea bien
                  y funcione como corresponde durante todo el año.
                </p>
              </div>
              ...
              <article className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_24px_80px_-64px_rgba(75,133,226,0.55)]">
                ...
                <div className="p-5 sm:p-6 md:p-8">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-[#4b85e2] sm:text-sm">Revestimiento</p>
                  <h3 className="mt-3 font-[var(--font-display)] text-2xl font-black tracking-tight text-[#12242c] sm:text-3xl md:text-4xl">
                    {services[0].title}
                  </h3>
                  <p className="mt-4 max-w-[44rem] text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">{services[0].description}</p>
                  <ul className="mt-6 grid gap-3 sm:grid-cols-2">
                    {services[0].points.map((point) => (
                      <li key={point} className="flex gap-3 text-base font-semibold text-slate-700">
                        <SealCheck className="mt-0.5 shrink-0 text-[#ffb600]" size={23} weight="fill" aria-hidden />
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <article className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_24px_80px_-64px_rgba(75,133,226,0.45)]">
                ...
                <div className="p-5 sm:p-6 md:p-8">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-[#4b85e2] sm:text-sm">Mantención</p>
                  <h3 className="mt-3 font-[var(--font-display)] text-2xl font-black tracking-tight text-[#12242c] sm:text-3xl">
                    {services[1].title}
                  </h3>
                  <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">{services[1].description}</p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-[0_30px_90px_-70px_rgba(75,133,226,0.65)] sm:p-6 lg:p-8">
              <div className="mb-10 grid gap-5 sm:mb-12 md:grid-cols-[0.8fr_1.2fr] md:items-end">
                ...
                <p className="max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 md:justify-self-end">
                  Cada tarjeta abre una ficha con ubicación, servicios realizados y una comparativa visual. Las fotos
                  actuales funcionan como base editable para reemplazar por material del cliente.
                </p>
              </div>
        ...
        <section id="contacto" className="px-4 pb-10 pt-8 sm:pb-14 sm:pt-10 md:px-6 md:pb-16 md:pt-12">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[1.75rem] bg-[#12242c] text-white shadow-[0_40px_120px_-70px_rgba(75,133,226,0.55)] lg:grid-cols-[0.9fr_1.1fr]">
            <div className="p-6 sm:p-7 md:p-10">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[#4b85e2] sm:text-sm">Contáctanos</p>
              ...
              <p className="mt-5 max-w-xl text-base leading-7 text-white/72 sm:text-lg sm:leading-8">
                Llámanos o escríbenos a nuestro WhatsApp para cotizar cualquiera de nuestros servicios. Estaremos
                encantados de atender tu requerimiento.
              </p>
      ...
      <footer className="bg-[#12242c] px-4 py-10 text-white md:px-6 md:py-14">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr_0.85fr_1fr]">
            <div>
              <Image src="/images/ipool-logo-sticker.png" alt="iPool" width={160} height={121} className="h-auto w-36" />
              <p className="mt-5 max-w-sm text-base leading-7 text-white/72">
                Revestimiento, limpieza y mantención de piscinas para que disfrutes agua clara durante todo el año.
              </p>
              <Link
                href={whatsappHref}
            ...
            <div>
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#ffb600]">Secciones</p>
            ...
            <div>
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#ffb600]">Servicios</p>
              <div className="mt-5 grid gap-3 text-sm font-extrabold text-white/74">
                {services.map((service) => (
                  <Link key={service.title} href="#servicios" className="transition hover:text-white">
                    {service.title}
                  </Link>
                ))}
              </div>
            ...
            <div>
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#ffb600]">Contacto</p>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 p-4">
                <p className="text-sm font-extrabold text-white">Atención en Chile</p>
                <p className="mt-2 text-sm leading-6 text-white/64">Cotizaciones para revestimiento, mantención y puesta a punto de temporada.</p>
              </div>
            </div>
          </div>
